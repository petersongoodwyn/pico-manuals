...
<div class="manual-step">
    ...
    <div class="step-description">
        ...
        <p>To identify resistors, you can either read color code printed on them or test them with a multi-meter set to read resistance. (Pro tip: to measure resistors quickly you can remove the probes from your multi-meter and place the leads of the resistor directly in the probe sockets.)</p>
    </div>
...
<div class="manual-step">
    <div class="step-image">
        <div class="single-item">
            <div><img src="%base_url%/assets/73p/01-res-trim-600.jpg" /></div>
            <div><img src="%base_url%/assets/73p/01-diodes-600.jpg" /></div>
        </div>
    </div>
